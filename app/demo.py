...
def main():
        ...
        with col2:
            tenure = st.slider('Tenure', min_value=tenure_min, max_value=tenure_max, step=1, value=36)
            tenure = scale_tenure(tenure)
            
        with col4:
            total_charges = st.slider('Total Charges', min_value=total_charges_min, max_value=total_charges_max, step=1, value=4500)
            total_charges = scale_total_charges(total_charges)
